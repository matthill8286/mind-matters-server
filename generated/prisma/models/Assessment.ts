...
export type AssessmentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "data" | "updatedAt", ExtArgs["result"]["assessment"]>
...
export interface AssessmentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const assessmentWithUserIdOnly = await prisma.assessment.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Assessments and only return the `userId`
   * const assessmentWithUserIdOnly = await prisma.assessment.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Assessments and only return the `userId`
   * const assessmentWithUserIdOnly = await prisma.assessment.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
